...
POM_DEVELOPER_EMAIL=Sample@email.com [Optional]
POM_DEVELOPER_ORGANIZATION=Org Name [Optional]
POM_DEVELOPER_ORGANIZATION_URL=https://github.com/chrisbanes/ [Optional]
```
